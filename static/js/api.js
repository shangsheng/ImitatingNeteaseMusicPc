...
//电台 - 付费精选
const _djPaygift = _Http + '/dj/paygift';
//退出登录
const _logout = _Http + '/logout'
// 以上是登录后的接口
//获取动态消息
...
//音乐是否可用
const _checkMusic = _Http + '/check/music';
// 搜索
...
//所有榜单
const _toplistAll = _Http + '/toplist';
//所有榜单内容摘要
const _toplistDetail = _Http + '/toplist/detail';
// 歌手榜
...
module.exports = {
  ...
  _checkMusic:_checkMusic,
  _logout:_logout,
  _toplistAll:_toplistAll,
  _toplistDetail:_toplistDetail,
  _djPaygift:_djPaygift
}