...
import {drage,seehref,getId,Playback,cutString,toggleBody,checkMusic,formatTime,
	...
	addBr,toboolean} from '../static/js/publics.js';
import rgbaster from '../static/js/rgbaster.min.js';
import eventVue from '../static/js/eventVue.js';
import {cookieUtil,localUtil,removeLocalStorage,delCookie,setLocalStorage} from '../static/js/browserStorage.js';
...
Vue.prototype.$ = $;
Vue.prototype.$host = 'http://localhost:3000';   //接口base地址
